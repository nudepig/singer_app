    ...
    return Scaffold(
      appBar: MyAppBar(
        ...
        child: CommonBackTopBar(
          title: "风险须知", onBack: () => Navigator.pop(context)
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          ...
          child: Column(children: <Widget>[
            Text('''尊敬的客户，在您下载xxx程序( 下称“APP")
使用我们的服务前，请仔细阅读本用户协议。
用户协议
本协议是您与xxx有限公司(以下简称“xxx”)签署的《用户协议》。您下载本APP并成功注
...
议，由xxx所在地人民法院管辖。''', style: TextStyle(
