...
class JhPickerTool {
  ...
  static void openModalQuit(
    ...
    new Picker(
        adapter: adapter,
        title: new Text(title ?? "确认取消",style:TextStyle(color: kTitleColor,fontSize: kTextFontSize)),
        selecteds: selecteds,
        cancelText: '取消',
        confirmText: '确认',
